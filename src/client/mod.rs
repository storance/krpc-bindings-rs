...
impl Connection {
    ...
    pub fn connect_with_ports(name: &str, host: &str, rpc_port: u16, stream_port: u16) -> Result<Connection, Error> {
...
impl Connection {
    ...
    pub fn invoke(&self, service: &str, procedure: &str, args: &Vec<Vec<u8>>) -> Result<Vec<u8>, Error> {
